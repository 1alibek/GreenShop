    ...
    <div>
      <div className="w-[90%] mx-auto">
        ...
        >
          ...
          >
            <Input.Password
              className="!pl-3 !border !border-[#eaeaea] !rounded-[5px] !h-[40px] !w-full focus:!border-primary focus:!outline-none !transition-all !duration-300 mt-3"
              placeholder="Password"
            />
          </Form.Item>
          <p className="text-primary text-end py-2">Forgot Password?</p>
