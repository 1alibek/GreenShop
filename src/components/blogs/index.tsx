  ...
  return (
    <div className="container2">
      {isAuthorization ? (
        ...
        <div>
          <div className="flex justify-between p-10 bg-[#fbfbfb]">
            <img
          ...
          <p className="text-center text-2xl font-medium px-6 mt-2">
          ...
          <button
            ...
            className="bg-primary text-white font-medium flex items-center gap-2 px-3 py-2 rounded-md border border-primary transition-all duration-300 hover:bg-transparent hover:text-primary mx-auto mt-4"
          >
            Join Greenshop
          </button>
        </div>
